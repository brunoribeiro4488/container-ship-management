...
public class ArqcpController {

    public boolean arqcp(String cargomanifestId) throws SQLException, IOException {
        Arqcp a = new Arqcp();
        ...
        String result = a.arqcp(databaseConnection,cargomanifestId);
        return print("Arqcp", result);
    }
    ...
    public boolean print(String fileName, String stringToPrint) throws IOException {
        ...
        return printer.print(fileName, stringToPrint,"US313" );
    }
}
